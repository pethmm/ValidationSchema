// src/lib.rs
/*
 * Core library for ValidationSchema
 */
...
#[derive(Debug)]
pub struct ValidationSchemaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ValidationSchemaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ValidationSchema processing");
    
    let mut processor = ValidationSchemaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ValidationSchemaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ValidationSchemaProcessor::new(false);
